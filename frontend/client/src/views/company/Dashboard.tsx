        ...
        <div style={styles.page}>
            ...
            <div style={styles.content}>
                <div style={styles.header}>
                    ...
                    <Link href="/company/post-job" style={styles.ctaBtn}>+ Post a Job</Link>
                </div>
                ...
                <div style={styles.section}>
                    <div style={styles.sectionHeader}>
                        ...
                        <Link href="/company/post-job" style={styles.viewAll}>+ New Job</Link>
                    </div>
                    {jobs.length === 0
                        ? <p style={styles.empty}>No jobs posted yet. <Link href="/company/post-job">Post your first job</Link></p>
                        : jobs.map(j => (
                            <JobCard
                                key={j.id}
                                title={j.title}
