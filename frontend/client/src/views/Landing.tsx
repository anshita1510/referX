        ...
        <header style={{ background: 'rgba(255,255,255,0.9)', backdropFilter: 'blur(12px)', borderBottom: '1px solid var(--color-border-light)' }}
            ...
            <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-3">
                    <Link href="/login" className="px-4 py-2 text-sm font-semibold transition-colors" style={{ color: 'var(--color-brand-dark)' }}>Sign In</Link>
                    <Link href="/register" className="btn-hero !py-2 !px-5 !text-sm">Get Started</Link>
                </div>
                ...
                {open && (
                    <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }}
                        ...
                        <div className="flex flex-col gap-2 mt-4">
                            <Link href="/login" className="btn-hero-outline !py-2.5 text-center" onClick={() => setOpen(false)}>Sign In</Link>
                            <Link href="/register" className="btn-hero !py-2.5 text-center" onClick={() => setOpen(false)}>Get Started Free</Link>
                        </div>
                    </motion.div>
                )}
            </AnimatePresence>
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16"
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
                ...
                <motion.div {...fadeUp(0.3)} className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
                    <Link href="/register" className="btn-hero text-base">Get Started Free</Link>
                    <Link href="/login" className="btn-hero-outline text-base">Sign In</Link>
                </motion.div>
            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col lg:flex-row gap-12 items-center">
                    <motion.div {...fadeUp(0)} className="flex-1">
                        ...
                        <Link href="/register?role=engineer" className="btn-hero inline-flex">Start Earning →</Link>
                    </motion.div>
